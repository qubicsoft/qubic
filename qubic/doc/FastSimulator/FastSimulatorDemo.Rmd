...
##### Getting FastSimulator output maps
new_maps_noise, coverage = Qubic_sky.get_partial_sky_maps_withnoise(noise_only=True, spatial_noise=False)
for i in range(newd['nf_recon']):
    for s in range(3):
...
global_dir = Qubic_DataDir(datafile='instrument.py', datadir=os.environ['QUBIC_DATADIR'])
DataFastSim = pickle.load( open( global_dir + '/doc/FastSimulator/Data/DataFastSimulator_{}_nfsub_{}.pkl'.format(config, newd['nf_recon']), "rb" ) )
