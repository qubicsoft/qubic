...
xx, yysim, bla = qss.get_noise_invcov_profile(m[0,:,:]-c[0,:,:], cov, doplot=True, QUsep=True,
                                   label='QUBIC MC Average IQU Nptg={}  Tol={}'.format(nptg,tol), fit=False, norm = False)
...
#xx, yysim, bla = qss.get_noise_invcov_profile(m[0,:,:]-c[0,:,:], cov, doplot=True, QUsep=True,
 #                                  label='Normalized QUBIC MC Average IQU Nptg={}  Tol={}'.format(nptg,tol), fit=False, norm = True)
#plt.plot(effective_variance_invcov[0,:], np.sqrt(effective_variance_invcov[1,:]),':',label='Qubic Law I', color = 'green')
#plt.plot(effective_variance_invcov[0,:], np.sqrt(effective_variance_invcov[2,:]),':',label='Qubic Law QU', color = 'red')
...
## zasto se opet fita noise koji je vec napravljen? yy je isti yysim
...
qubicnoise = Qubic_sky.create_noise_maps(86, cov, effective_variance_invcov=effective_variance_invcov)
