...
Namaster = nam.Namaster(msk, lmin=lmin, lmax=lmax, delta_ell=delta_ell)
```
...
# Get spectra
leff, cells, w = Namaster.get_spectra(maps, d, nlb=16, purify_e=False, purify_b=False)
print(leff)
```
