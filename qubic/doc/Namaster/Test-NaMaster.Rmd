...
# Get spectra
leff, cells, w = Namaster.get_spectra(maps, mask_apo, 
                                      purify_e=True, 
                                      purify_b=False, 
...
leff_nobeam, cells_nobeam, w_nobeam = Namaster.get_spectra(smooth_maps, mask_apo, 
                                                           purify_e=True, 
                                                           purify_b=False, 
                                                           beam_correction=None)
leff_beam, cells_beam, w_beam = Namaster.get_spectra(smooth_maps, mask_apo, 
                                                     purify_e=True, 
                                                     purify_b=False, 
...
```{python}
# This function gives you the pixel window correction
...
leff_pw, cells_pw, w_pw = Namaster.get_spectra(pw_seenmaps, mask_apo, 
                                                           purify_e=True, 
                                                           purify_b=False, 
                                                           beam_correction=None,
                                                           pixwin_correction=True)

leff_nopw, cells_nopw, w_nopw = Namaster.get_spectra(pw_seenmaps, mask_apo, 
                                                           purify_e=True, 
                                                           purify_b=False, 
                                                           beam_correction=None,
                                                           pixwin_correction=None)
...
for sim in range(nsim):
    Qubic_sky, x0, maps_observed = make_maps(d, seenpix, noise_level=0.)
    maps = maps_observed[0].T
    leff, cells, w = Namaster.get_spectra(maps, mask_apo, purify_e=True, purify_b=False, beam_correction=None)
...
for i in range(4):
    plt.subplot(2, 2, i+1)
    plt.plot(input_ell, input_Dl[:, i], label='Input spectra')
    plt.errorbar(leff, mean_cells[:, i], std_cells[:, i], fmt='m.', label='Reconstructed Dls')
