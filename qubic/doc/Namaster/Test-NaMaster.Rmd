...
# This part should be removed, JC ?
...
plot(input_ell, input_Dl[:, 0])
plot(ell_binned, Dls_binned[0, :],'o')
xlabel('$\\ell$')
ylabel('$D_\\ell$')
```
...
# Get spectra
leff, cells, w = Namaster.get_spectra(maps, d, mask_apo, purify_e=False, purify_b=False)
```
