...
plt.savefig(f'/home/lmousset/QUBIC/These_manuscrit/Figures/Plots/Namaster_{clnames[i]}_auto-cross.pdf')
#tkz.save(f'/home/lmousset/QUBIC/These_manuscrit/tikz/Namaster_{clnames[i]}_auto-cross.tex')
```
...
plt.figure()
plt.plot(xx, np.exp(-(xx-50)**2/150), 'r', lw=2)
