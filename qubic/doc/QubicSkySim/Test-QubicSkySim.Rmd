...
x0 = np.reshape(Qubic_sky1.get_simple_sky_map(),(d['nf_sub'],d['nside']**2*12,3))
...
x0 = np.reshape(Qubic_sky2.get_simple_sky_map(),(d['nf_sub'],d['nside']**2*12,3))
print('Input Map with shape (nf_sub, #pixels, #stokes) : ', np.shape(x0))
...
x0 = np.reshape(Qubic_sky3.get_simple_sky_map(),(d['nf_sub'],d['nside']**2*12,3))
print('Input Map with shape (nf_sub, #pixels, #stokes) : ', np.shape(x0))
...
### 4.3 Retrieving the input CMB maps and spectra
...
```{python}
### Choose either of the three follwing cases
