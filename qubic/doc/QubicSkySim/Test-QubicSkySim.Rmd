...
# ### CAMB call
# ell, totDl, unlensedDl = qss.get_camb_Dl(r=0.1, lmax=3*nside)

# ### Synfast (NB: we need to go from Dl to Cl due to different conventions between CAMB and synfast)
# mycls = qss.Dl2Cl_without_monopole(ell, totDl)
...
ell, totDL, unlensedDL = qss.get_camb_Dl(r=0.1, lmax=3*d['nside'])
