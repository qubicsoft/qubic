...
### Horns for FI
d['config'] = 'FI'
instFI = Qinstrument.QubicInstrument(d)
...
instTD = Qinstrument.QubicInstrument(d)
...
```{python}
# location of maximum 
maxx, maxy = np.unravel_index(np.argmax(mapFI), shape=(200, 200))
