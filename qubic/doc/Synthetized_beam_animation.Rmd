...
for TES in range(20):
    ...
    hp.gnomview(sb[TES], min=0, max=1000, rot=(180, 90), reso=25, title=None)
    for p in range(npeaks):
        ...
        hp.visufunc.projtext(th, ph, str(p), color=color, fontsize=10)

```

```{python}
hp.gnomview(sb[200], min=0, max=1e6, rot=(180, 90), reso=8, title=None)
