...
# hdu['quadrant'].data = new
# hdu.writeto(basedir + 'calfiles/CalQubic_DetArray_v4_' + config + '.fits', overwrite=True)
```
...
!!! **The calibration file is defined in the ONAFP frame. Homever, QUBIC soft works in the GRF frame. For this reason there is a pi/2 rotation between the following plots and the previous ones from the calibration file.**
