...
save_dir = '/home/lmousset/QUBIC/Images/'
...
q.horn.plot(facecolor_open='grey', alpha=0.6)
#q1.horn.plot(facecolor_open='grey', alpha=0.2)

plt.axis('square')
plt.rc('font', size=10) 
fig.tight_layout()
plt.savefig(save_dir + 'horn_FI.png', bbox_inches='tight', transparent=True)
```
