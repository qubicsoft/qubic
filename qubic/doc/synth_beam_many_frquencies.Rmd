...
newmap_mb.append(np.diag(np.roll(np.roll(sec_beam[0], half-maxx_0, axis=0), half-maxy_0, axis=1)))
maxx_1_mb, maxy_1_mb = np.unravel_index(np.argmax(sec_beam[1]), dims=(size,size))
newmap_mb.append(np.diag(np.roll(np.roll(sec_beam[1], half-maxx_1, axis=0), half-maxy_1, axis=1)))
