...
Model_QS = scal.Model_Fringes_QubicSoft(baseline)
```
...
```{python}
xONAFP, yONAFP, fringes = Model_QS.get_fringes(q,
...
plt.subplot(121)
scal.scatter_plot_FP(q, xONAFP, yONAFP, fringes[:, 0], frame='ONAFP', title='Scatter plot', norm=None)

plt.subplot(122)
scal.pcolor_plot_FP(q, xONAFP, yONAFP, fringes[:, 0], frame='ONAFP', title='pcolor plot', norm=None)
```
...
x, y, S, Cminus_i, Sminus_ij, Cminus_j, Ci, Cj, Sij = Model_QS.get_all_combinations_power(q, 
                                                                             theta=[0], phi=[0], 
                                                                             nu=150e9, spectral_irradiance=1.,
                                                                             frame='ONAFP',
...
x, y, fringes_true = Model_QS.get_fringes_from_combination(q,
                                                    measured_comb=False,
                                                    theta=[0], phi=[0], 
                                                    nu=150e9, spectral_irradiance=1.,
                                                    frame='ONAFP',
...
x, y, fringes_meas = Model_QS.get_fringes_from_combination(q,
                                                    measured_comb=True,
                                                    theta=[0], phi=[0], 
                                                    nu=150e9, spectral_irradiance=1.,
                                                    frame='ONAFP',
...
Model_Maynooth = scal.Model_Fringes_Maynooth(baseline)
```

```{python}
xONAFP_TES, yONAFP_TES, powerTES = Model_Maynooth.get_fringes_Maynooth(q, rep, 
...
```{python}
xONAFP_TES, yONAFP_TES, fringes_comb_TES = Model_Maynooth.get_fringes_Maynooth_combination(q, rep,
                                                                              measured_comb=True,
                                                                              theta=np.array([0.]), nu=150e9,
                                                                              interp=False,
                                                                              verbose=True)
