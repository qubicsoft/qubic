...
def run_asic(fpobj, idnum, Vtes, fff, dc, asic, reselect_ok=False, lowcut=0.5, highcut=15., nbins=50,
        ...
        folding_result = fold_data(time, dd, 1. / fff, lowcut, highcut, nbins, notch=notch)
