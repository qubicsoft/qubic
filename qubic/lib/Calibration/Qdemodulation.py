...
class Demodulation:
	...
	def demodulate_JC(self, period, indata, indata_src, others=None, verbose=False, template=None, quadrature=False,
				  remove_noise=False):
	...
	def demodulate_methods(self, data_in, fmod, fourier_cuts=None, verbose=False, src_data_in=None, method='demod',
	...
	#
		...
		# RMS method: calculate the RMS in each period (beware ! it returns noise+signal !)
			return self.return_rms_period(period, data, others=others, verbose=verbose,
