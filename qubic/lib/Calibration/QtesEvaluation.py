...
def get_header_values(dataset=None, analysis=None, analyser=None, elog=None, wikipage=None):
    """
...
def write_goodbad(goodbad, dataset=None, analysis=None, analyser=None, elog=None, wikipage=None):
    """
    write a FITS file with a good/bad info
    """

    hdrval = get_header_values(dataset, analysis, analyser, elog, wikipage)
