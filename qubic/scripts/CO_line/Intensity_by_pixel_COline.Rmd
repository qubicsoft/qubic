...
def plot_COband(nus_edge_qubic, CO21_GHz):
    plt.figure(figsize=(8, 6))
    plt.xlabel('f [GHz]')
    plt.axvline(CO21_GHz, color='g')
    for ed in nus_edge_qubic:
...
```{python}
COsky = make_CO21_sky(nf_sub, d['nside'])
