...
# We need to do that because there is a bug in qubic pack but will be solved soon
time_azel = a.timeaxis(datatype='hk', axistype='pps')-18532.5
az = a.azimuth()
el = a.elevation()
asic = 1
...
todabs = np.abs(tod)
# todabs = demodulate_methods(tod, 1., method='absolute_value')
```
