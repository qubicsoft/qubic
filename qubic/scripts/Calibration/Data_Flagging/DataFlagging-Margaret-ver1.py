...
class FlagData(object):
    ...
    def flag_1Ktemp_rise_beta(self, step = 80, interpolate = True, verbose = False):    
        ...
        """
        Author: Margaret Haun
        Created: 2023-06-27 16:25:00 CET
        Description:  Flag 1K temperature raise
        ...
        Returns:
            ...
            in order to have the same dimenssion of arrays
            
        A timestamp is flagged if the slope of the line between the timestamp[i] and timestamp[i+step] is greater than 7.5e-06 (interpolated using tod()[0]).
        The corresponding flagid is 30,
        flag_i = bit30*2**30
        """
