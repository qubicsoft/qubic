...
```{python}
thr = [3e5, 5e5]  # Multiple thresholds for better detection
...
```{python}
utils.save_results(results, output_dir=data_path + "year_25_day_2805_15.09.12", dataset_name="2805_15.09.12")
```
...
```{python}
utils.save_results(results, output_dir=data_path + "year_25_day_2805_15.36.55", dataset_name="2805_15.36.55")
```
...
```{python}
utils.save_results(results, output_dir=data_path + "year_25_day_2805_16.11.43", dataset_name="2805_16.11.43")
```
