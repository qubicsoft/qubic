...
# data_dir = global_dir + '2019-12-19-fringes/'

# January measurement
data_dir = global_dir + '2020-01-13-fringes/'


datasets = np.sort(glob.glob(data_dir+'/*switch*'))
print(datasets)
...
t_data1, data1 = fl.cut_data(wt[ids]/1000. - 0.1, None, t_data1, data1)
t_data2, data2 = fl.cut_data(wt[ids]/1000. - 0.1, None, t_data2, data2)
```

```{python}
plt.plot(t_data1, data1[27])
plt.xlim(0, 40)
```
...
datasets = np.sort(glob.glob(data_dir+'/*RF_switch*'))
print(datasets)
...
```{python}
# equiv = [0,0,1,2,1,2] 
equiv = [0, 1, 0, 1, 2, 2, 3, 2, 0, 4, 5, 0]
# equiv = [0, 0, 0, 0, 0, 0, 0, 1]
...
rc('figure', figsize=(16, 10))
for i, ids in enumerate(mydsequiv):
#     ids = mydsequiv[i]
