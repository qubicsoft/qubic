...
# Get the datasets
datasets, allBLs, allNcycles, allwt, BLs_sort, BLs_type = fl.get_fringes_datasets(global_dir + date, 'RF_switch_ncy', q)
...
for i, ids in enumerate(BLs_sort[type_eq]):
    ...
    print("    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    ")
    print(f'     * dsnum={ids} {BL}')#.format(ids, BL[0], BL[1]))    
