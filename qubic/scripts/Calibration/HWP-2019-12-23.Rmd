...
print(thvals)
reload(dl)
# alldata = [[vals_rms, err_rms], [vals_fit, err_fit], [vals_fitSimSrc, err_fitSimSrc], [-vals_demod, err_demod*0+1]]
# names = ['RMS', 'Fit', 'FitSimSrc', 'Demod']

# alldata = [[vals_rms, err_rms], [vals_demod, err_demod*0+1]]
# names = ['RMS', 'Demod']
