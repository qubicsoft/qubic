...
top_dir = '/sps/hep/qubic' # in CC-IN2P3
user_dir = 'Users/satorchi' 
...
elif (machine=='apcdhcp98.in2p3.fr') or (machine=='MacJCH-2.local'):
    print('==========================================')
...
user_dir = 'Users/mmgamboa'
fitted_directory = os.sep.join([top_dir,user_dir,freq_subdir[freq_name],'FitSB'])
if not os.path.isdir(fitted_directory):
    print('Directory not found: ',fitted_directory)
