...
dirallfreqs = os.environ["QUBIC_TODDIR"]
dirfreq = '150GHz-2019-04-06/'
dirfiles = dirallfreqs + dirfreq
dirsave = dirallfreqs + dirfreq + "FitSB/"
dir_sym = dirallfreqs + dirfreq + "FitSB/"
dir_asym = dirallfreqs + dirfreq + "FitSB/"
...
newxxyy=show_flatmap_fit_res(dirfiles, dir_sym , 93, cbar=True)
subplot(1,3,1)
#for i in range(9):
plot(xxyynew[0], xxyynew[1],'r+')
```
