...
S, Cminus_i, Cminus_j, Sminus_ij, Ci, Cj, Sij = ca.get_power_combinations(q, theta=[np.deg2rad(0.)], phi=[[0.]], nu=150e9, reso=102)
...
q = qubic.QubicInstrument(d)
q.optics.focal_length = 0.35
fringes = ca.compute_fringes(q, theta=[np.deg2rad(0)], phi=[np.deg2rad(0.)], reso=34, nu=150e9, xmin=-0.051, xmax=0.051)
...
# plt.savefig('/home/louisemousset/QUBIC/Qubic_images/plots/fringes_no_aber_25_57_focal35')
```
