...
Clearly, if there is a bug, it comes from the function get_power_fp_aberration that I copied here with some simplifications in order to check it. 
...
# I don't see the problem, I think the data are well projected...

nn = 241
files = sorted(glob.glob(rep + '/*.dat'))
datfile = pd.read_csv(files[0], sep='\t', skiprows=0)
print(datfile.head(6))
