...
for i in range(len(comp)):
    ...
    if comp_name[i] == 'CMB':
        ...
        comp_for_pcg[i] = Ctrue(components[i])#C_2degree(components[i].copy())
    elif comp_name[i] == 'SYNCHROTRON':
        comp_for_pcg[i] = Ctrue(components[i])#C_2degree(components[i].copy())# * 0#Ctrue(components[i])
    elif comp_name[i] == 'CO':
        comp_for_pcg[i] = Ctrue(components[i])#C_2degree(components[i].copy())# * 0
    else:
