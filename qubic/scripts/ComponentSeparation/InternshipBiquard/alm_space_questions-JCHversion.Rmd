...
```{python}
plot(fref,np.array(vals_beta),'o-', label='Not Pixwin Corrected')
plot(fref,np.array(vals_beta_pwcorr),'o-', label='Pixwin Corrected')
ylim(0,2)
...
for i in range(len(fref)):
    print(fref[i], vals_beta_pwcorr[i])
```
