...
subplot(1,2,1)
toto = lambda a : heaviside(a-150,1)
plot(xxx, toto(xxx))

subplot(1,2,2)
from sympy.parsing.sympy_parser import parse_expr
import sympy
analytic_expr = ('heaviside(x-nu0,0.5)')
truc = parse_expr(analytic_expr, local_dict={'nu0':150})
func=sympy.lambdify(x,truc,modules=["numpy"])
plot(xxx, func(xxx))
```
...
test = AnalyticComponent(analytic_expr, nu0=353, temp=20., h_over_k=H_OVER_K)
print('test:',test.params)

xxx = np.linspace(100,500, 1000)
plot(xxx, dust.eval(xxx, 1.54))
plot(xxx, test.eval(xxx, 1.54))
