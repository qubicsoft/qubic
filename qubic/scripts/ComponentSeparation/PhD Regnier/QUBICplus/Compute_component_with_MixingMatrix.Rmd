...
mysolution_s4=compute_rdots(comp, np.round(rs4.x, 3), instr_s4, map_cmbdust_s4_noiseless, 5)
mysolution_bi=compute_rdots(comp, np.round(rbi.x, 3), instr_bi, map_cmbdust_bi_noiseless, 15)
```
