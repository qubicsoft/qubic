...
mapdiff = mapsb_pos-mapsb_neg
mapdiff[unseen] = hp.UNSEEN
hp.gnomview(mapsb, rot=[np.mean(newazt), np.mean(newelt)], reso=12, sub=(1,4,1), title='Both scans', min=0, max=np.max(mapsb[~unseen]))
hp.gnomview(mapsb_pos, rot=[np.mean(newazt), np.mean(newelt)], reso=12, sub=(1,4,2), title='+ scans', min=0, max=np.max(mapsb[~unseen]))
hp.gnomview(mapsb_neg, rot=[np.mean(newazt), np.mean(newelt)], reso=12, sub=(1,4,3), title='- scans', min=0, max=np.max(mapsb[~unseen]))
