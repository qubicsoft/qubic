...
```{python}
def display_one(mapsb, anatype='', sub=(1,1,1)):
...
This means that we expect no signal below 2 Hertz, we can then filter these modes out.
...
mytod_butter_LP = ft.butter_bandpass_filter(mytod, 1./10000000, fcut, sampling, order=2)
...
```{python}
# Display Results
display_one(mapsb, anatype='TS, Az/El Corrected', sub=(2,3,1))
display_one(mapsb_brute_LP, anatype='Brute LP', sub=(2,3,2))
display_one(mapsb_butter_LP, anatype='Butter LP', sub=(2,3,3))
display_one(mapsb_brute_BP, anatype='Brute BP', sub=(2,3,5))
display_one(mapsb_butter_BP, anatype='Butter BP', sub=(2,3,6))
