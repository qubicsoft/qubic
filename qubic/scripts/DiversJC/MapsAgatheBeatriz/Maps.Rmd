...
for i in range(nb):
    if (i%100) == 0: print(i)
    mm += show_gnom_around_pix(themap[:,0], mypixels[i], reso, xsize=npixmap) / nb
    mmQ += show_gnom_around_pix(themap[:,1], mypixels[i], reso, xsize=npixmap) / nb
    mmU += show_gnom_around_pix(themap[:,2], mypixels[i], reso, xsize=npixmap) / nb
