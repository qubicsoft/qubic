...
#Raw qss map
raw_qss_map = np.transpose(Qubic_sky.get_simple_sky_map(), (0, 2, 1))

#Raw PySM map

instrument = get_instrument('qubic')
raw_pysm_map = get_observation(instrument, 'c1', nside=256)

print(np.std((raw_qss_map - raw_pysm_map)[:,:,:], axis=2))
