...
allnus = qubic_acquisition.allnus.copy()
...
for i in range(len(allnus)):
    print(f'Scaling map from {nu_ref} GHz to {qubic_acquisition.allnus[i]:3f} GHz with factor {sed[i][0]:3f}')

k=0
delta = skymodel - np.mean(skymodel, axis=0)
