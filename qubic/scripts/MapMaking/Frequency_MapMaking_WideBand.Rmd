...
```{python}
# Qubic acquisitions
qubic_acquisition_150 = Acq.QubicIntegrated(d150, Nsub=Nf_TOD, Nrec=Nf_TOD, integration ='')
qubic_acquisition_220 = Acq.QubicIntegrated(d220, Nsub=Nf_TOD, Nrec=Nf_TOD, integration ='')
