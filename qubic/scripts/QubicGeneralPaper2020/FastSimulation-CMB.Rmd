...
bla = qss.get_noise_invcov_profile(qubicnoise, cov, label='FastSim', fit=False, allstokes=True)
blo = qss.get_noise_invcov_profile(m[0,:,:]-c[0,:,:], cov, 
                                   label='QUBIC MC Average IQU Nptg={}  Tol={}'.format(nptg,tol), fit=False)
plot(effective_variance_invcov[0,:], np.sqrt(effective_variance_invcov[1,:])*avg[0],'--',label='Qubic Law')
xlim(0,12)
ylim(0,2.5)
legend()
```
...
nbmc = 50
alllmin = [10, 15, 20, 25]
alldelta_ell = [40, 45, 50, 55, 60, 65, 70]
allcovcut = [0.1, 0.15, 0.2, 0.25, 0.3]
print(6*len(alllmin)*len(alldelta_ell)*len(allcovcut)*nbmc/3600)
...
for lmin in alllmin:
    for delta_ell in alldelta_ell:
        for covcut in allcovcut:
            ...
            with open('/Users/hamilton/Qubic/QubicGeneralPaper2020/Sims/FastSimsNoise/res_{}_{}_{}.pickle'.format(lmin, delta_ell, covcut), 'wb') as handle:
            ...
            with open('/Users/hamilton/Qubic/QubicGeneralPaper2020/Sims/FastSimsNoise/rescov_{}_{}_{}.pickle'.format(lmin, delta_ell, covcut), 'wb') as handle:
                                pickle.dump(alloutputs, handle)
...
leff,mcl,scl = read_one('/Users/hamilton/Qubic/QubicGeneralPaper2020/Sims/FastSimsNoise/', 10, 40, 0.2)
