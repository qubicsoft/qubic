...
### Run the MC
nbmc = 30
leff, mcl_noise_qubic, scl_noise_qubic, covbin = run_mc(nbmc, Namaster, cov, d, configs)
...
like, cumint, rlim68, rlim95 = explore_like(leff, scl*0, BBcov, lmin, delta_ell, covcut, rv,
...
for s in range(4):
    ...
    title('QUBIC {}x{} - {} years'.format(configs[0],configs[1], dA['effective_duration']))
tight_layout()
...
plot_errors_lines(leff, scl, delta_ell, 'r', label='QUBIC {} - {} years'.format(d['config'], dA['effective_duration']))
...
subplot(1,2,2)
plot(rv,like, label='QUBIC {} - {} years'.format(d['config'], dA['effective_duration']))
