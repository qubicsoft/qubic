...
#     list_files = glob.glob(rep_spectrumCC + f'IBCSsame*nfrecon{nfrecon}*_qubicmaps_*FI150*_v4_gal*.npy')
...
#             f'IBCSsame_nfrecon{nfrecon}_qubicmaps_FI150_v4_galaxycenter.npy', allcross)
```
...
# plt.savefig('/home/lmousset/QUBIC/Qubic_work/SpectroImagerie/paper_plot/IBCS_noiseBBsame150_GoodPhotonNoise_v4.pdf')
```
