...
hp.graticule(dpar = dpar, dmer = dmer, alpha = 0.6, verbose = True)
...
plt.savefig('FastSim-TD-Figs/TD{}_CMB-dust_nrec{}_nside{}_pixQ{}_pixG{}_Intensity_grat.pdf'.format(FuncModel.__name__,
                                                                               dTD['nf_recon'],nside_new,
                                                           pix_ud, pix_ud), 
