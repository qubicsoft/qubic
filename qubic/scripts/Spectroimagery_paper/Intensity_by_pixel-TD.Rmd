...
hp.gnomview(mapsTD_ud[-1,:,0], reso = 15,
            ...
            unit = r'$\mu$K',
            rot = center)
hp.projscatter(hp.pix2ang(nside_new, pix_ud), marker = '*', color = 'r', s = 200)
...
#ax[0].plot(x, ImvalsTD, 'g', label = 'Best fit modified Black-Body')
ySED_fit = quad(x, *p_opt)
ax[0].fill_between(x, y1 = ySED_fit - IsvalsTD, y2 = ySED_fit + IsvalsTD, 
                   color = 'g', alpha = 0.3, label = '68% C.L.')


ax[0].set_title('TD - {} year'.format(dTD['effective_duration']), fontsize = 14)
ax[0].set_ylabel(r'$I(\nu)~[\mu$K]', fontsize = 14)
ax[0].set_xlabel(r'$\nu~[GHz]$', fontsize = 14)
...
hp.gnomview(mapsTD_ud[3,:,0], reso = 15, hold = True, notext = True, 
            ...
            unit = r'$\mu$K',
            rot = center)
hp.projscatter(hp.pix2ang(nside_new,pix_ud),marker='*',color='r', s = 180)
#plt.savefig('FastSim-TD-Figs/TDnrec{}_nside{}_pixQ{}_pixG{}_Intensity.svg'.format(dTD['nf_recon'],nside_new,
#                                                           pixQ_ud, pixG_ud), 
#            format = 'svg')
plt.savefig('FastSim-TD-Figs/TD{}_nrec{}_nside{}_pixQ{}_pixG{}_Intensity.pdf'.format(FuncModel.__name__,
                                                                               dTD['nf_recon'],nside_new,
                                                           pix_ud, pix_ud), 
            format = 'pdf')
plt.savefig('FastSim-TD-Figs/TD{}_nrec{}_nside{}_pixQ{}_pixG{}_Intensity'.format(FuncModel.__name__, 
                                                                           dTD['nf_recon'],
...
#ax[0].plot(x, PmeanTD, 'g', label = 'Best fit modified Black-Body')
...
hp.gnomview(auxmapG,
            ...
            rot = center)
hp.projscatter(hp.pix2ang(nside_new,pix_ud),marker = '*', s = 180, color = 'r',)
#plt.savefig('FastSim-TD-Figs/TDnrec{}_nside{}_pixQ{}_pixG{}_Polarization.svg'.format(d150Q['nf_recon'],nside_new,
#                                                           pixQ_ud, pixG_ud), 
#            format = 'svg')
plt.savefig('FastSim-TD-Figs/TD{}_nrec{}_nside{}_pixQ{}_pixG{}_Polarization.pdf'.format(FuncModel.__name__,
                                                                               dTD['nf_recon'],nside_new,
                                                           pix_ud, pix_ud), 
            format = 'pdf')
plt.savefig('FastSim-TD-Figs/TD{}_nrec{}_nside{}_pixQ{}_pixG{}_Polarization'.format(FuncModel.__name__, 
                                                                           dTD['nf_recon'],
                                                                           nside_new,pix_ud, pix_ud))
plt.show()
```
