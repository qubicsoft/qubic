...
# NEW (16 Feb 2021)
reload(fsed)
noise = fsed.noise_qss(dictionaries, sky_conf, coveragesmaps, 40, verbose = False) 
...
#NEW (16 feb 2021)
reload(fsed)
maps, _ = fsed.foreground_with_noise(dictionaries, sky_conf, regions, bands, 40)
```
...
```{python}
hp.gnomview(maskmaps[3, 3, :, 0], reso = 14)
```
