...
maps_ud, std_ud, noise_ud_i = fsed.udgrade_maps(fground_maps, noise, nside_new, nf_recon, nreals)
```
...
```{python}
ySED_fit.shape, Perr.shape, xarr.shape, nus_out150.shape, nus150.shape, maps_ud.shape
```
