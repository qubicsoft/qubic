...
pixQ = [hp.ang2pix(dictionaries[0]['nside'], 
                   np.pi / 2 - np.deg2rad(centers[0][1] + 11), np.deg2rad(centers[0][0] - 10  ) ), ]
pixG = [hp.ang2pix(dictionaries[0]['nside'], 
                   np.pi / 2 - np.deg2rad(centers[2][1] + 10), np.deg2rad(centers[2][0] + 8 ) ), ]
...
plt.tight_layout()
plt.savefig('Figs-FI-SED/March2021/hits_param_space_{}_{}_{}_{}_{}.svg'.format(FuncModel.__name__,
...
ySED_fit, Pmean, Perr = fsed.make_fit_SED(xSED, xarr, Imvals, Isvals,
                                          ...
                                          initP0 = np.array([1e9, 3, 1e12, 2.5]), 
                                          maxfev = 15000)
```
...
plt.tight_layout()
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Intensity_grat.svg'.format(FuncModel.__name__,
                                                                            d150Q['nf_recon'],nside_new,
                                                           pixQ_ud, pixG_ud), 
            format = 'svg', bbox_inches='tight')
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Intensity_grat.pdf'.format(FuncModel.__name__,
                                                                               d150Q['nf_recon'],nside_new,
                                                           pixQ_ud, pixG_ud), 
            format = 'pdf', bbox_inches='tight')
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Intensity'.format(FuncModel.__name__, 
                                                                           d150Q['nf_recon'],
...
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Polarization_grat.svg'.format(FuncModel.__name__,
                                                                d150Q['nf_recon'], nside_new,
                                                           pixQ_ud, pixG_ud), 
            format = 'svg', bbox_inches='tight')
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Polarization_grat.pdf'.format(FuncModel.__name__,
                                                                d150Q['nf_recon'], nside_new,
                                                           pixQ_ud, pixG_ud), 
            format = 'pdf', bbox_inches='tight')
plt.savefig('Figs-FI-SED/March2021/{}_nrec{}_nside{}_pixQ{}_pixG{}_Polarization_grat'.format(FuncModel.__name__,
                                                                           d150Q['nf_recon'], 
                                                                           nside_new,pixQ_ud, pixG_ud),
           bbox_inches='tight')
plt.show()
