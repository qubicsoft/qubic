...
if readfiles:
    ...
    maps_ud, _, fgr_map_ud, noise_ud_i = fsed.udgrade_maps(fground_maps, noise, nside_new, nf_recon, nreals)
    _, covmask = fsed._mask_maps(maps, coveragesmaps, nf_recon)
    cov_ud = hp.ud_grade(covmask, nside_new)
    Cp = []
    Cp_prime = []
...
if not readfiles:
    ...
    FitsArray(noise_ud_i).save("SED_NoiseMaps_nside{}_nreals{}.fits".format(nside_new,nreals))
