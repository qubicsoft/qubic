...
```{python}
Cp150Q_prime[:, :, istk, pixQ_red].shape, maps150Q_ud.shape
```
...
for j in range(1):#enumerate(range(600,12000,500)):
    ...
    ax[0].plot(nus_out150, maps150G_ud[:,IPIXG,0], 'ro-', label='reconstructed')
    ax[0].fill_between(x150, y1 = mvals150G - svals150G, y2 = mvals150G + svals150G, 
                       color = 'r', alpha = 0.5)
    #ax[0].plot(x220, mvals220G , 'ro-')
    ax[0].plot(nus_out220, maps220G_ud[:,IPIXG,0] , 'ro-')
    ...
    #       fmt='o-', color='r',alpha=0.8)
    ax[2].plot(nus_out150, maps150Q_ud[:,IPIXQ,0], 'ro', label='reconstructed')
    ax[2].fill_between(x150, y1 = mvals150Q - svals150Q, y2 = mvals150Q + svals150Q, 
                       color = 'r', alpha = 0.5)
    ax[2].plot(nus_out220, maps220Q_ud[:,IPIXQ,0], 'ro')
