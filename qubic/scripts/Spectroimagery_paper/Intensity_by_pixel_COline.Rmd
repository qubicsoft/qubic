...
_, maps_convolved_CO = arec.get_observation(COsky, noiseless=d['noiseless'], convolution=True)
...
for pix in pix_indices:
    ...
    plt.plot(nus, COsky[:, pix, istk], 'go', label='Input sky')
