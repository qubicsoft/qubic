...
```{python}
np.save('./BBcross_dust_d1_' + config[-3:] + f'_{nbands}bands_dustfrac0-0.01-step0.001.npy', BBcross_dust)
```

```{python}
BBcross_dust = np.load('./BBcross_dust_d1_' + config[-3:] + f'_{nbands}bands_dustfrac0-0.01-step0.001.npy')
# BBcross_dust = np.load('./BBcross_dust_d1_' + config[-3:] + f'_{nbands}bands_dustfrac0-0.05-step0.005.npy')
# BBcross_dust = np.load('./BBcross_dust_d1_' + config[-3:] + f'_{nbands}bands_dustfrac0-0.05-step0.01.npy')
