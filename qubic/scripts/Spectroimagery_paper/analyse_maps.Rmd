...
```{python}
reload(amc)
coco, _ = amc.get_covcorr_patch(all_patch_diff)
plt.figure(figsize=(16,16))
plt.figure('Mean over pixels')
plt.subplot(121)
plt.imshow(np.mean(coco, axis=2), interpolation = 'none')
plt.title('Mean cov')
#plt.colorbar()
plt.subplot(122)
plt.imshow(np.mean(_, axis=2), interpolation = 'none')
plt.title('Mean corr')
#plt.colorbar()
...
```{python}
coco2,_ = amc.get_covcorr_patch(all_patch_diff, stokesjoint = True)
plt.figure(figsize=(16,16))
plt.figure('Mean over pixels')
plt.subplot(121)
plt.imshow(np.mean(coco2, axis=2), interpolation = 'none')
plt.title('Mean cov')
#plt.colorbar()
plt.subplot(122)
plt.imshow(np.mean(_, axis=2), interpolation = 'none')
