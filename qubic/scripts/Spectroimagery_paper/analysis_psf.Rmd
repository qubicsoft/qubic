...
Look at the profile of the reconstructed maps for each frequency. Plot the profile for each sub-band
    ...
    for j,ifrec in enumerate(use):
        ...
        for jk,irec in enumerate(allrecon):
            if len(irec[NUS])==0:
                ...
                yvals.append(irec[NUS][nreal,ifrec,pixel,0]*NormFact)

        ax[j].set_title(r'band - {:.0f}-{:.0f}GHz'.format(nusfulledge[NUS][ifrec],
