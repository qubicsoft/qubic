...
_, _, nus_recon, _,_,_ = qubic.compute_freq(d['filter_nu']/1e9, Nfreq = nf_recon, 
...
ax.plot(nusfull["4"], fwhmTh(nusfull["4"]), 
        color = 'b', marker = 'o', ms = 10, alpha = 0.5, ls = "",
...
for i in [8,16,32,64,128,256,512]:
    ...
    print("{} \t {:.1f} \t {:.1f} \t {:.1f} \t {:.1f} \t {:.1f} \t {:.1f}\
     \t {:.1f} \t {:.1f} \t {:.1f} \t {:.1f}".format(i, resol, 
                                          ...
                                          qreso(170)/resol, #qreso(180)/resol,
                                          qreso(190)/resol, qreso(210)/resol,
                                          qreso(230)/resol, qreso(250)/resol,))
```
