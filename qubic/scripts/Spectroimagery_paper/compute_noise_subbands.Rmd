...
sig2MC, sigMCmean = amc.get_sig2MC(weighted_av_prime, ang, ang_threshold=d['dtheta'])
...
sig2MC_monofreq, sigMCmean_monofreq = amc.get_sig2MC(patch_recon_monofreq, ang, ang_threshold=d['dtheta'])
sigMCmean_monofreq
```
...
for irec in d['nf_recon']:
    ...
    if irec == 1:
        ...
        sig2MC_monofreq, sigMCmean_monofreq = amc.get_sig2MC(recon_patch, ang, ang_threshold=ang_th)
        ...
        sig2MC, sigMCmean = amc.get_sig2MC(weighted_av, ang, ang_threshold=ang_th)
        ...
        sig2MC_prime, sigMCmean_prime = amc.get_sig2MC(weighted_av_prime, ang, ang_threshold=ang_th)
...
```{python}
p = plot_sig_mean(dict_sig2MC, d['nf_recon'], color='g', signame='sigMC')
```

```{python}
p = plot_sig_mean(dict_sig2MC_prime, d['nf_recon'], color='b', signame='sigMC_prime')
```

```{python}
p = plot_sig_mean(dict_sig2, d['nf_recon'], color='r', signame='sig')
```

```{python}
p = plot_sig_mean(dict_sig2_prime, d['nf_recon'], color='orange', signame='sig_prime')
