...
```{python}
def get_Cp(rep_simu, date_name, irec, nfrecon, verbose=True, doplot=True):
...
```{python}
map_recon_patch, Cp = get_Cp(rep_simu, date_name, irec=3, nfrecon=d['nf_recon'])
```
