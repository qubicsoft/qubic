...
for jsimu in range(len(par)):
    ...
    condition0 = par[jsimu]['nep'] == 1e-18#par[jsimu]['npoint'] == 3000#
    condition1 = parZ[jsimu]['nep'] == 1e-18 #parZ[jsimu]['npoint'] == 3000#
    condition2 = par3Z[jsimu]['nep'] == 1e-18#par3Z[jsimu]['npoint'] == 3000#
    ...
    for ist, istokes in enumerate('IQU'):
        ...
        for izones in nzones:
            if izones == 1: 
                if condition0:
                    if istokes == 'I':                         
                        #print(len(rms_i[jsimu]['{}'.format(kfreq)]), len(rms_i[jsimu]['{}'.format(kfreq)]))
