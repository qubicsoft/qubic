...
name = 'noiseless_hwp_nospectro_05'
...
#     if simu==0:
#         pp = p
#         pp.angle_hwp = I[0]*11.25 # pour les simus avec l'angle par palier
...
#         #hwp angle fix
#         pp.angle_hwp = np.concatenate((pnew.angle_hwp, np.tile(11.25*I[simu], 500)))
...
#     name = 'fix_hwp_0to7_500ptg_0' + str(simu+1)
