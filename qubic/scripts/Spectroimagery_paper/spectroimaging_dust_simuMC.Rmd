...
for band in range(nf_sub_rec):
    hp.gnomview(maps_conv[real, band, :, istk], cmap='jet', sub=(nf_sub_rec, 3, 3*band+1), 
                rot=center, reso=rr, notext=True,
                title = '{} conv'.format(d['kind'][istk]), min=min, max=max)
    plt.text(-0.8,0, '{:3.0f} GHz'.format(nus[band]))
    hp.gnomview(maps_recon[real, band, :, istk], cmap='jet', sub=(nf_sub_rec, 3, 3*band+2), 
                rot=center, reso=rr, notext=True,
                title = '{0} rec'.format(d['kind'][istk]), min=min, max=max)
    hp.gnomview(maps_residuals[real, band, :, istk], cmap='jet', sub=(nf_sub_rec, 3, 3*band+3), 
                rot=center, reso=rr, notext=True,
...
hp.gnomview(toto[band, :, istk], cmap='jet', sub=(133), 
                rot=center, reso=rr, notext=True, min=-10, max=10,
