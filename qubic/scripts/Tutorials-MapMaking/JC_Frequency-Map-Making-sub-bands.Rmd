...
if user == 'Pierre' or user == 'Mathias':
    ...
    solution_qubic_planck = pcg(A, b, x0=None, M=M, tol=tol, disp=True, maxiter=100)
elif user == 'full':
    solution_qubic_planck = pcg(A, b, x0=m_planck_for_tod, M=M, tol=tol, disp=True, maxiter=100)
elif user == 'old':
    solution_qubic_planck = pcg(A, b, x0=m_planck_for_tod[0], M=M, tol=tol, disp=True, maxiter=50)
else:
    raise TypeError('We would like to have more people..')
```
...
```{python}
import pickle
thesolution = solution_qubic_planck['x'].copy()
...
print(myfwhms)
print(myweights)
mytoto = toto(solution_qubic_planck['x'], m_sub, seenpix, myfwhms, myweights, center, verbose=True)
...
mytoto2 = toto(solution_qubic_planck['x'], m_sub, seenpix, myfwhms, myweights, center, verbose=False)
