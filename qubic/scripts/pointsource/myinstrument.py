...
class QubicInstrument(Instrument):
    ...
    def _get_projection_operator(
        ...
        if only_cen:
        	thetas, phis, vals = np.array([[0.038181347]]), np.array([[ 2.2009643]]), 1e27*np.array([[36.14002372]])
        else:
        	...
        	vals = 1e27*np.array([[17.14002, 9.95124, 9.61292, 1.32998 , 15.66893, 16.772,  3.33062, 7.42635,  10.25307]])
            #,  0.53203,1.06430]])#,  0.68101,  40.56667]])
        	#print('thetas: ', thetas)
	...
	#return (ProjectionOperator(s, shapeout=shapeout),), thetas, phis, vals
